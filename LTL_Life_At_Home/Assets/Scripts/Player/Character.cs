...
public class Character : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        canvasHub = GameObject.FindGameObjectWithTag("CanvasHub");
    }
...
/*            Debug.Log(keyDownCount);*/
 ...
 /*           Debug.Log(keyDownCount);*/
        ...
        {
            if (keyDownCount < 2 )// fix error make player stuck if press 2 move key the same time
            {
                OnMoveButtonUp();
            }
            keyDownCount--;
        ...
        if (Input.GetKeyDown(KeyCode.Escape))
        {
            ...
            if (isPause)
            {
                canvasHub.GetComponent<UIButtonController>().OnResumeClick();
                isPause = false;
            }
            else
            {
                canvasHub.GetComponent<UIButtonController>().OnPauseClick();
                isPause = true;
            }
        }
